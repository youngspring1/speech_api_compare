...
// This document is provided 揳s-is? Information and views expressed in this document, including URL and other Internet Web site references, may change without notice.  
...
(function (Bing) {
   ...
   // Bing._defaultVoiceName = "Microsoft Server Speech Text to Speech Voice (en-US, ZiraRUS)";
    Bing._defaultVoiceName = "Microsoft Server Speech Text to Speech Voice (ja-JP, Ayumi, Apollo)";
    function write(text) {
